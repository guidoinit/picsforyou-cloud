...
export default function App() {
  ...
  return (
    <div id="java-storage-root" className="min-h-screen bg-bg text-text font-sans flex flex-col md:grid md:grid-cols-[320px_1fr_40px] border border-line overflow-x-hidden selection:bg-accent selection:text-white">
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-bg">
        ...
        {/* Main Hero Header (hidden when viewing documentation) */}
            ...
            <div className="flex-1 overflow-y-auto p-3 lg:p-4">
              <div className="max-w-5xl mx-auto space-y-4">
                ...
                <div className="flex items-center gap-4 flex-wrap">
                  <h2 className="text-lg font-black tracking-tight uppercase">API Documentation</h2>
                  <span className="text-subtext font-mono text-[10px] flex items-center gap-2">
                    <span>BASE: <span className="text-accent">http://localhost:3000</span></span>
                    <span className="text-line">|</span>
                    <span>AUTH: <span className="text-accent">Basic</span></span>
                  </span>
                </div>
  ...
  "message": "File deleted successfully"
                  ...
                  <div key={group.section}>
                    <h3 className="text-sm font-bold uppercase tracking-wider text-accent border-b border-line pb-1 mb-3">
                      {group.section}
                    </h3>
                    <div className="space-y-3">
                      {group.endpoints.map((ep, i) => (
                        <div key={i} className="bg-[#0c0c0c] border border-line rounded overflow-hidden">
                          <div className="flex items-center gap-2 px-3 py-1.5 border-b border-line bg-panel/50">
                            ...
                            <span className="font-mono text-[11px] text-text font-semibold">{ep.path}</span>
                            <span className="text-subtext text-[10px] ml-auto truncate">{ep.description}</span>
                          </div>
                          <div className="grid grid-cols-2 divide-x divide-line/30">
                            <div className="px-3 py-1.5">
                              <div className="text-[9px] text-subtext font-mono uppercase tracking-wider mb-0.5">Request</div>
                              <pre className="text-[10px] text-text font-mono whitespace-pre-wrap break-all leading-relaxed">{ep.request}</pre>
                            </div>
                            <div className="px-3 py-1.5">
                              <div className="text-[9px] text-subtext font-mono uppercase tracking-wider mb-0.5">Response</div>
                              <pre className="text-[10px] text-green-300/80 font-mono whitespace-pre-wrap break-all leading-relaxed">{ep.response}</pre>
                            </div>
                          </div>
                        </div>
                      ))}
                ...
                <div className="border border-line rounded p-2 bg-panel/30">
                  <p className="text-[10px] text-subtext font-mono">
                    ...
                    as password. Session endpoints use a JWT cookie from <code className="text-text">/api/v1/auth/login</code>.
                  </p>
                </div>
